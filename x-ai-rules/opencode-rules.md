...
>
> All files in the `x-ai-rules/` folder are loaded automatically at the start of every session.
...
**At the start of every session, read `x-ai-rules/opencode-chat-settings.md`** to get the current configured values:
...
- **Rules path** (`Rules path:`) – the folder from which all rules files are loaded (this folder, `x-ai-rules/`)
...
├── x-ai-templates/        # Templates for different note types
└── x-ai-rules/            # System files, AI rules, configuration
```

### Rules:
- **Read `x-ai-rules/opencode-chat-settings.md`** at the start of every session for the current folder values
...
When creating new notes **ALWAYS use the appropriate template** from `x-ai-templates/`:

- `x-ai-templates/project.md` – for new projects
- `x-ai-templates/task.md` – for tasks
- `x-ai-templates/note.md` – for free-form notes
- `x-ai-templates/decision.md` – for decisions
- `x-ai-templates/conversation.md` – for AI conversations
- `x-ai-templates/reference.md` – for references
...
2. **Load the appropriate template** from `x-ai-templates/`
...
1. Load template `x-ai-templates/project.md`
2. Fill in:
...
1. Template `x-ai-templates/task.md`
...
Do:
- **Read `x-ai-rules/opencode-chat-settings.md` first** to get the current folder values
- Use templates from `x-ai-templates/`
...
Don't:
- Hardcode folder names – always read them from `x-ai-rules/opencode-chat-settings.md`
